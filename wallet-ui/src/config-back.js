...
//链ID
export const API_CHAIN_ID = localStorage.hasOwnProperty('chainID') ? Number(localStorage.getItem('chainID')) : 10;
//燃烧地址的公钥
...
//ChainId和资产ID
export const MAIN_INFO = RUN_DEV ? {chainId: 10, assetsId: 1} : {chainId: 2, assetsId: 1};
